...
router.post('/login', (req, res, next) =>{
    ...
    if (result.error === null) {
        ...
        SELECT 
            ...
            sidapem.menu_klp.akses_unit as akses_unit
        ...
        LEFT JOIN sidapem.menu_klp 
            ON sidapem.menu_klp.id = egov.users.sidapem
            ...
            if(row.length <= 0) {
                ...
                const payload =  {
                    ...
                    profile : {
                        ...
                        akses_unit : user.akses_unit,
                        trista_monev : user.trista_monev,
                        sidapem : user.sidapem,
