...
router.post('/list', (req, res) => {
    ...
    if (req.body.unit_kerja == null || req.body.unit_kerja == undefined || req.body.unit_kerja == "") {
        filter_unit = `AND biodata.unit_kerja = '`+userx.unit_kerja+`'`
    } else {
        filter_unit = `AND biodata.unit_kerja = '`+req.body.unit_kerja+`'`
    }
...
router.post('/getOne', (req, res) => {
    ...
    console.log("getOne Biodata ", req.body);
    ...
    let view = ` 
        ...
        WHERE biodata.nip = '`+req.body.nip+`'
