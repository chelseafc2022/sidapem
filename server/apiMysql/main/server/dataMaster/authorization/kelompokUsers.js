...
router.post('/view', (req, res) => {
    console.log('menu_akses dari middleware:', req.menu_akses);
...
router.post('/addData', (req, res) => {
    ...
    var query = `
        INSERT INTO menu_klp (uraian, akses_unit) VALUES ('`+ form.uraian + `', `+form.akses_unit+`);
    `
