<template>
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 frame_cari">
                <span class="h_lable ">Nilai (Rp)</span>
                <q-input type="number" v-model="form.nilai" outlined square :dense="true" class="bg-white margin_btn" /> 
            </div>
            ...
            <div class="col-12 col-md-12 frame_cari">
                <span class="h_lable ">Nama Penerima</span>
                <q-input v-model="form.penerima" outlined square :dense="true" class="bg-white margin_btn" /> 
            </div>
            <div class="col-12 col-md-12 frame_cari">
                <span class="h_lable ">Alamat Penerima</span>
                <q-input v-model="form.penerima_alamat" outlined square :dense="true" class="bg-white margin_btn" /> 
            </div>
    ...
    mounted () {
        ...
        if (this.type == 2) {
            ...
            this.form = {
                ...
                no : dtx.no,
                nilai : dtx.nilai,
                penyedia : dtx.penyedia,
                penerima : dtx.penerima,
                penerima_alamat : dtx.penerima_alamat,
