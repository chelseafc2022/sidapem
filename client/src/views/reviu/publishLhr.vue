      ...
      <q-card-section class="main2 text-white">
        <div class="row">
          <div class="col-12 col-md-4">
            <div class="text-h6 h_titleHead">Publish LHR</div>
             ...
             <tr class="h_table_head bg-blue-2">
              ...
              <tr class="h_table_body" v-for="(data, index) in list_data" :key="data.id">
                ...
                <q-btn-group>
                    ...
                    <q-btn v-if="tipe == 1 || tipe == 4 || tipe == 5 || tipe == 6 || tipe == 7 || tipe == 8 || tipe == 9 " @click="selectData(data), mdl_edit = true" glossy color="orange" icon="create" class="tbl_btn">
                    <q-tooltip content-class="bg-orange-9" content-style="font-size: 13px">
                        Click untuk mengubah data ini
                    </q-tooltip>
                    </q-btn>

                    <q-btn v-if="tipe == 1 || tipe == 4 || tipe == 5 || tipe == 6 || tipe == 7 || tipe == 8 || tipe == 9 " @click="selectData(data), mdl_hapus = true" glossy color="negative" icon="delete_forever" class="tbl_btn">
