      ...
      <q-card-section class="main1 text-white">
        <div class="row">
          <div class="col-12 col-md-4">
            ...
            <div class="text-h6 h_titleHead">Kertas Kerja Reviu</div>
            <div class="text-subtitle2">KKR Hasil Reviu</div>
          </div>
          <div class="col-12 col-md-4">
          ...
          <div class="col-12 col-md-4">
            <div class="row">
              ...
              <q-btn v-if="tipe == 1 || tipe == 4 || tipe == 5 || tipe == 6 || tipe == 7 || tipe == 8 || tipe == 9  " glossy class="tambah" @click="mdl_add = true" dense flat icon="add" style="margin-right: 5px; width: 10%;">
          ...
          <!-- =================================================== KONTENT =========================================================== -->
            <table width="100%">
             <tr class="h_table_head main1x_1">
                ...
                <th class="text-left" style="width:35%">Nama File</th>
                <th class="text-left" style="width:35%">Keterangan</th>
              ...
              <tr class="h_table_body" v-for="(data, index) in list_data" :key="data.id">
                ...
                <q-btn-group>
                    ...
                    <q-btn v-if="tipe==1 || tipe==8" @click="selectData(data), mdl_edit = true" glossy color="orange" icon="create" class="tbl_btn">
                    <q-tooltip content-class="bg-orange-9" content-style="font-size: 13px">
                        Click untuk mengubah data ini
                    </q-tooltip>
                    </q-btn>

                    <q-btn v-if="tipe==1 || tipe==8" @click="selectData(data), mdl_hapus = true" glossy color="negative" icon="delete_forever" class="tbl_btn">
...
export default {
  ...
  methods: {
    ...
    getView : function(){
      ...
      fetch(this.$store.state.url.URL_kkr + "view", {
            method: "POST",
            headers: {
     ...
     lokasiData : function(id){
       ...
       addData: function(){
        ...
        fetch(this.$store.state.url.URL_kkr + 'addData', {
            method: "POST",
            headers: {
                authorization: "kikensbatara " + localStorage.token
            },
    ...
    editData: function(){
        ...
        fetch(this.$store.state.url.URL_kkr + 'editData', {
            method: "POST",
            headers: {
                authorization: "kikensbatara " + localStorage.token
            },
    ...
    removeData : function(E){
      fetch(this.$store.state.url.URL_kkr + "removeData", {
          method: "POST",
          headers: {
            "content-type": "application/json",
            authorization: "kikensbatara " + localStorage.token
