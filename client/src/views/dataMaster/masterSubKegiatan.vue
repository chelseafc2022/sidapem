      ...
      <q-card-section class="main1 text-white">
        <div class="row">
          <div class="col-12 col-md-6">
            <div class="text-h6 h_titleHead">Master Sub-Kegiatan</div>
          ...
          <!-- =================================================== KONTENT =========================================================== -->
            <table width="100%">
              <tr class="h_table_head main1x_1">
                ...
                <th width="45%">Program / Kegiatan</th>
              ...
              <template v-for="(data, index) in list_data">
                <tr class="h_table_body main1xx_1" :key="data.id+'a'+index">
                    ...
                    <td class="text-center">
                        <q-btn-group>
                        <q-btn @click="mdl_add = true, selectData(data)" glossy icon="add" class="tbl_btn main1">
                            <q-tooltip content-class="bg-purple-9" content-style="font-size: 13px">
                            Click untuk menambah Master Sub-Kegiatan
                            </q-tooltip>
                        </q-btn>
                        </q-btn-group>
                ...
                <template v-for="(data1, index1) in data.sub_kegiatan">
                  <tr class="h_table_body bg-white" :key="data1.id+'.'+index+'.'+index1">
                    <td class="text-center"></td>
                    <td class="">{{data1.kode_full}}</td>
                    <td colspan="2">
                      {{data1.uraian}}

                    </td>
                    <td class="text-center">
                      <q-btn round dense color="orange" size="xs" icon="create" @click="mdl_edit = true, selectSubKegiatan(data1)" />
                      <q-btn round dense color="red-10" size="xs" icon="clear" @click="mdl_hapus = true, selectSubKegiatan(data1)" style="margin-left:5px"/>
