        ...
        <q-card-section class="main1 text-white">
          <div class="row">
            <div class="col-12 col-md-6">
              <div class="text-h6 h_titleHead">Master Program</div>
            ...
            <!-- =================================================== KONTENT =========================================================== -->
              <table width="100%">
                ...
                <tr class="h_table_body" v-for="(data, index) in list_data" :key="data.id">
                    ...
                    <td>
                        {{data.uraian}}
                        <div class="h_nip">{{ data.urusan_bidang_uraian }}</div>
                    </td>
  ...
  export default {
    ...
    methods: {
      ...
      getView : function(){
        ...
        fetch(this.$store.state.url.RL_DM_PROGRAM + "view", {
            method: "POST",
            headers: {
      ...
      addData : function() {
        fetch(this.$store.state.url.RL_DM_PROGRAM + "addData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
      ...
      editData : function(){
        fetch(this.$store.state.url.RL_DM_PROGRAM + "editData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
      ...
      removeData : function(E){
        fetch(this.$store.state.url.RL_DM_PROGRAM + "removeData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
