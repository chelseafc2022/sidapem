                    ...
                    <q-card-section class="q-pt-none">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-md-12 frame_cari">
                            ...
                            <q-input v-model="form.uraian" outlined square :dense="true" class="bg-white" />

                            <span class="h_lable ">*Akses Unit</span>
                            <select v-model="form.akses_unit" class="bg-white margin_btn">
                                <option value="1">-- 1 Sub Unit Kerja --</option>
                                <option value="2">-- 1 Unit Kerja --</option>
                                <option value="3">-- Semua Unit Kerja --</option>
                            </select>
  ...
  export default {
    ...
    methods: {
      ...
      selectData : async function(data){
          ...
          this.form.akses_unit = data.akses_unit;
