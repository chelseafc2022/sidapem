        ...
        <q-card-section class="main1 text-white">
          <div class="row">
            <div class="col-12 col-md-6">
              <div class="text-h6 h_titleHead">Bidang Urusan</div>
        ...
        <q-card-section>
          ...
          <div class="row">
            <div class="col-12 col-md-6 rowLeft">
                ...
                <select v-model="filterku.urusan_kode" @change="cari_data()" class="bg-white">
            ...
            <!-- =================================================== KONTENT =========================================================== -->
              <table width="100%">
                ...
                <tr class="h_table_body" v-for="(data, index) in list_data" :key="data.id">
                    ...
                    <td class="text-center">{{data.urusan_kode}}.{{data.kode}}</td>
                    <td>
                        {{data.uraian}}
                        <div class="h_nip">{{ data.urusan_uraian }}</div>
                    </td>
                      ...
                      <q-card-section class="q-pt-none">
                          ...
                          <div class="row">
                            ...
                            <div class="col-12 col-md-12 frame_cari">
                                ...
                                <select v-model="form.urusan_kode" class="bg-white margin_btn">
                                    <option v-for="data in $store.state.list_urusan" :key="data.id" :value="data.kode_full">[{{ data.kode }}]. {{ data.uraian }}</option>
                                </select>
                            </div>
  ...
  export default {
    ...
    methods: {
      ...
      getView : function(){
        ...
        fetch(this.$store.state.url.URL_DM_URUSAN_BIDANG + "view", {
            method: "POST",
            headers: {
      ...
      addData : function(number) {
        fetch(this.$store.state.url.URL_DM_URUSAN_BIDANG + "addData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
      ...
      editData : function(){
        fetch(this.$store.state.url.URL_DM_URUSAN_BIDANG + "editData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
      ...
      removeData : function(E){
        fetch(this.$store.state.url.URL_DM_URUSAN_BIDANG + "removeData", {
            method: "POST",
            headers: {
              "content-type": "application/json",
              authorization: "kikensbatara " + localStorage.token
