...
<q-input outlined square :dense="true" class="bg-white" placeholder="Password" type="password">
  <template v-slot:prepend>
                  <q-icon name="vpn_key" />
                </template>
</q-input>
  ...
  <span class="h_fotter_title">Copyright : Diskominfo & DKPSDM Kab. Konawe Selatan</span>
        ...
        <div class="putihTrans formLogin shadow-5">
          ...
          <form @submit.prevent="btn_login()">
            ...
            <q-input v-model="user.password" outlined square :dense="true" class="bg-white" placeholder="Password"
              type="password">
              <template v-slot:prepend>
                <q-icon name="vpn_key" />
              </template>
          ...
          <div class="transAbu text-center">
            <!-- <span class="h10">Copyright : Bagian Adm. Pembangunan Setda & DiskominfoSandi  <br>Kab.Konawe Selatan</span> -->
            <span class="h10">Copyright : Bagian Administrasi Pembangunan & DiskominfoSandi <br>Sekretariat Daerah
              Kab.Konawe
              Selatan</span>
          </div>
        </div>
